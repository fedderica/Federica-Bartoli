...
function problemB () {
 ...
 // readFile('poem-one/stanza-02.txt', function (err, stanza2) {
  ...
  promisifiedReadFile('poem-one/stanza-02.txt').then((st2) =>{
    blue(st2)
  })
  promisifiedReadFile('poem-one/stanza-03.txt').then((st3) =>{
    blue(st3)
})
...
function problemD () {
 ...
 // });
  ...
  // promise version
  // ???  
     promisifiedReadFile('poem-one/wrong-file-name.txt') //caso de exito
     .then(st4 => {
      blue (st4)
     }, err => {      //MAneja caso de error 
...
function problemF () {
 ...
 // });
  ...
  // promise version
  // ???
  promisiefiedReadFile('poem-one/stanza-03.txt')
  .then((st3)=>{
    blue(st3)
    return promisifiedReadFile ('poem-one/wrong-file-name.txt')
  })
